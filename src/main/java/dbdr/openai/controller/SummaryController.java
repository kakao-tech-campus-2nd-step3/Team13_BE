...
@Tag(name = "Chart 요약 API", description = "차트 하루 요약")
@RestController
@RequiredArgsConstructor
@RequestMapping("/${spring.app.version}/chart/summary")
public class SummaryController {

    private final SummaryService summaryService;

    @Operation(summary = "차트 요약 후 요약한 값과 태그를 DB에서 불러온다.", description = "차트 아이디로 요약 데이터와 요약태그를 불러온다.")
    @GetMapping
